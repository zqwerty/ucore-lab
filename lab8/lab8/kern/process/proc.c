...
alloc_proc(void) {
     ...
     */
     //LAB5 2014011336 : (update LAB4 steps)
    /*
    ...
    //LAB8:EXERCISE2 2014011336 HINT:need add some code to init fs in proc_struct, ...
	proc->filesp = NULL;
    }
    return proc;
}
...
do_fork(uint32_t clone_flags, uintptr_t stack, struct trapframe *tf) {
    ...
    //LAB8:EXERCISE2 2014011336  HINT:how to copy the fs in parent's proc_struct?
    /*
